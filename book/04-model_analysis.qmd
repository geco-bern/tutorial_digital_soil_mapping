...
Now that we have our predictions ready, we can extract standard metrics for a regression problem (see [AGDS Chapter 8.2.2](https://geco-bern.github.io/agds_book/regression_classification.html#regression)).
