...
all_rasters
```
Note that above, we have stacked only a random of all available raster data (`list_raster_subset`) which we have generated previously.
