...
This tutorial builds on the course [Applied Geodata Science I](https://geco-bern.github.io/agds_book/) and requires basic knowledge in using the tidyverse and Random Forests for data analysis.
:::
